...
flowname = 'i-LIDS-VID-FLOW'
posename = 'i-LIDS-VID-POSE'
...
class iLIDSVIDSEQUENCE(Datasequence):
    ...
    def imgextract(self):
        ...
        exdir3 = osp.join(raw_dir, posename)
        # fpath1 = osp.join(raw_dir, datasetname + '.tar')
        # fpath2 = osp.join(raw_dir, flowname + '.tar')
        ...
        if True:
            ...
            fpaths1 = sorted(glob(osp.join(exdir1, 'sequences', '*/*/*.png')))
            fpaths2 = sorted(glob(osp.join(exdir2, "sequences", '*/*/*.png')))
            fpaths2 = sorted(glob(osp.join(exdir3, "sequences", '*/*/*.png')))
